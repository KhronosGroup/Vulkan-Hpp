...
namespace VULKAN_HPP_NAMESPACE
{
  ...
  struct SharedHeader
  {
    SharedHeader( SharedHandle<DestructorType> parent, Deleter deleter VULKAN_HPP_DEFAULT_SHARED_DELETER_ASSIGNMENT( Deleter() ) ) VULKAN_HPP_NOEXCEPT
  ...
  {
    SharedHeader( Deleter deleter VULKAN_HPP_DEFAULT_SHARED_DELETER_ASSIGNMENT( Deleter() ) ) VULKAN_HPP_NOEXCEPT : deleter( std::move( deleter ) ) {}
...
#  endif
  ...
  public:
    ...
    explicit SharedHandle( HandleType                                 handle,
                           ...
                           DeleterType deleter VULKAN_HPP_DEFAULT_SHARED_DELETER_ASSIGNMENT( DeleterType() ) ) VULKAN_HPP_NOEXCEPT
...
#  endif
  ...
  struct ImageHeader : SharedHeader<DestructorTypeOf<Image>, typename SharedHandleTraits<Image>::deleter>
  {
    ImageHeader( SharedHandle<DestructorTypeOf<Image>>       parent,
                 typename SharedHandleTraits<Image>::deleter deleter 
                   VULKAN_HPP_DEFAULT_SHARED_DELETER_ASSIGNMENT( typename SharedHandleTraits<Image>::deleter() ),
  ...
  public:
    ...
    explicit SharedHandle( Image                                 handle,
                           ...
                           SwapchainOwns                         swapchain_owned VULKAN_HPP_DEFAULT_SHARED_DELETER_ASSIGNMENT( SwapchainOwns::no ),
                           DeleterType                           deleter VULKAN_HPP_DEFAULT_SHARED_DELETER_ASSIGNMENT( DeleterType() ) ) VULKAN_HPP_NOEXCEPT
  ...
  struct SwapchainHeader
  {
    SwapchainHeader( SharedHandle<SurfaceKHR>                           surface,
                     ...
                     typename SharedHandleTraits<SwapchainKHR>::deleter deleter 
                        VULKAN_HPP_DEFAULT_SHARED_DELETER_ASSIGNMENT( typename SharedHandleTraits<SwapchainKHR>::deleter() ) ) VULKAN_HPP_NOEXCEPT
