...
void VulkanHppGenerator::readCommand( tinyxml2::XMLElement const * element )
{
  ...
  else
  {
    ...
    checkElements( line, children, { { "param", MultipleAllowed::Yes }, { "proto", MultipleAllowed::No } }, { "implicitexternsyncparams" } );
...
void VulkanHppGenerator::readExtension( tinyxml2::XMLElement const * element )
{
  ...
  checkElements( line, children, { { "require", MultipleAllowed::Yes } }, { "deprecate", "remove" } );
...
void VulkanHppGenerator::readFormat( tinyxml2::XMLElement const * element )
{
  ...
  checkAttributes(
    ...
    { { "blockExtent", { "1", "2", "3", "4", "5", "6", "8", "10", "12" } },
      ...
      { "packed", { "8", "16", "32" } } } );
  std::vector<tinyxml2::XMLElement const *> children = getChildElements( element );
  checkElements( line, children, { { "component", MultipleAllowed::Yes } }, { "plane", "spirvimageformat" } );
...
std::pair<VulkanHppGenerator::NameData, TypeInfo> VulkanHppGenerator::readNameAndType( tinyxml2::XMLElement const * element )
{
  ...
  std::vector<tinyxml2::XMLElement const *> children = getChildElements( element );
  checkElements( line, children, { { "name", MultipleAllowed::No } }, { { "enum" }, { "type" } } );
...
void VulkanHppGenerator::readStructMember( tinyxml2::XMLElement const * element, std::vector<MemberData> & members, bool isUnion )
{
  ...
  checkAttributes( line,
                   ...
                   { { "altlen", {} },
                     ...
                     { "values", {} } } );
  std::vector<tinyxml2::XMLElement const *> children = getChildElements( element );
  checkElements( line, children, { { "name", MultipleAllowed::No }, { "type", MultipleAllowed::No } }, { "comment", "enum" } );
...
void VulkanHppGenerator::readSync( tinyxml2::XMLElement const * element )
{
  ...
  std::vector<tinyxml2::XMLElement const *> children = getChildElements( element );
  checkElements(
    line, children, { { "syncaccess", MultipleAllowed::Yes }, { "syncpipeline", MultipleAllowed::Yes }, { "syncstage", MultipleAllowed::Yes } }, {} );
...
void VulkanHppGenerator::readTypeFuncpointer( tinyxml2::XMLElement const * element, std::map<std::string, std::string> const & attributes )
{
  ...
  if ( nameIt != children.end() )
  {
    ...
    checkElements( line, children, { { "name", MultipleAllowed::No } }, { "type" } );
  ...
  else
  {
    ...
    checkElements( line, children, { { "proto", MultipleAllowed::No } }, { "param" } );
...
void VulkanHppGenerator::readTypes( tinyxml2::XMLElement const * element )
{
  ...
  checkAttributes( line, getAttributes( element ), {}, { { "comment", {} } } );
  std::vector<tinyxml2::XMLElement const *> children = getChildElements( element );
  checkElements( line, children, { { "type", MultipleAllowed::Yes } }, { "comment" } );
...
void VulkanHppGenerator::readVideoCodec( tinyxml2::XMLElement const * element )
{
  ...
  std::vector<tinyxml2::XMLElement const *> children = getChildElements( element );
  checkElements( line, children, { { "videocapabilities", MultipleAllowed::Yes } }, { "videoformat", "videoprofiles" } );
