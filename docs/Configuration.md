...
The following macros may be defined in a build system or in the command-line invocation of a compiler to configure the behaviour and features of Vulkan-Hpp.
