...
Contributions to the Vulkan-Hpp repository are welcome.
...
license identifier](https://spdx.dev/learn/handling-license-info/) of the
license applying to that file, rather than
