...
namespace VULKAN_HPP_NAMESPACE
{
  ...
  {
    static std::map<std::string, std::string> deprecatedExtensions = { { "VK_EXT_debug_report", "VK_EXT_debug_utils" },
                                                                       { "VK_NV_glsl_shader", "" },
  ...
  {
    static std::map<std::string, std::string> promotedExtensions = { { "VK_KHR_sampler_mirror_clamp_to_edge", "VK_VERSION_1_2" },
