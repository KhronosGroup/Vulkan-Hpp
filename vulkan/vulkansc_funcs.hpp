...
#  endif /*VULKAN_HPP_NO_EXCEPTIONS*/
    ...
    Device::getFaultData( VULKAN_HPP_NAMESPACE::FaultQueryBehavior faultQueryBehavior, Dispatch const & d ) const
  {
    ...
    do
    {
      ...
      if ( ( result == VK_SUCCESS ) && faultCount )
      {
        faults.resize( faultCount );
        result = d.vkGetFaultData( m_device,
                                   static_cast<VkFaultQueryBehavior>( faultQueryBehavior ),
  ...
  template <typename FaultDataAllocator,
            typename Dispatch,
            typename B2,
            typename std::enable_if<std::is_same<typename B2::value_type, FaultData>::value, int>::type>
  VULKAN_HPP_NODISCARD VULKAN_HPP_INLINE
    typename ResultValueType<std::pair<VULKAN_HPP_NAMESPACE::Bool32, std::vector<VULKAN_HPP_NAMESPACE::FaultData, FaultDataAllocator>>>::type
...
#  endif /*VULKAN_HPP_NO_EXCEPTIONS*/
                       ...
                       PhysicalDevice::getRefreshableObjectTypesKHR( Dispatch const & d ) const
  {
    ...
    do
    {
      result = d.vkGetPhysicalDeviceRefreshableObjectTypesKHR( m_physicalDevice, &refreshableObjectTypeCount, nullptr );
      if ( ( result == VK_SUCCESS ) && refreshableObjectTypeCount )
      {
        refreshableObjectTypes.resize( refreshableObjectTypeCount );
        result = d.vkGetPhysicalDeviceRefreshableObjectTypesKHR(
  ...
  template <typename ObjectTypeAllocator,
            typename Dispatch,
            typename B1,
            typename std::enable_if<std::is_same<typename B1::value_type, ObjectType>::value, int>::type>
  VULKAN_HPP_NODISCARD VULKAN_HPP_INLINE typename ResultValueType<std::vector<VULKAN_HPP_NAMESPACE::ObjectType, ObjectTypeAllocator>>::type
...
#  ifndef VULKAN_HPP_DISABLE_ENHANCED_MODE
                       ...
                       Device::getFenceSciSyncFenceNV( const VULKAN_HPP_NAMESPACE::FenceGetSciSyncInfoNV & getSciSyncHandleInfo, Dispatch const & d ) const
  {
    ...
    HandleType handle;
    VkResult   result = d.vkGetFenceSciSyncFenceNV( m_device, reinterpret_cast<const VkFenceGetSciSyncInfoNV *>( &getSciSyncHandleInfo ), &handle );
    resultCheck( static_cast<VULKAN_HPP_NAMESPACE::Result>( result ), VULKAN_HPP_NAMESPACE_STRING "::Device::getFenceSciSyncFenceNV" );
...
#  ifndef VULKAN_HPP_DISABLE_ENHANCED_MODE
                       ...
                       Device::getFenceSciSyncObjNV( const VULKAN_HPP_NAMESPACE::FenceGetSciSyncInfoNV & getSciSyncHandleInfo, Dispatch const & d ) const
  {
    ...
    HandleType handle;
    VkResult   result = d.vkGetFenceSciSyncObjNV( m_device, reinterpret_cast<const VkFenceGetSciSyncInfoNV *>( &getSciSyncHandleInfo ), &handle );
    resultCheck( static_cast<VULKAN_HPP_NAMESPACE::Result>( result ), VULKAN_HPP_NAMESPACE_STRING "::Device::getFenceSciSyncObjNV" );
...
#  ifndef VULKAN_HPP_DISABLE_ENHANCED_MODE
    ...
    Device::importFenceSciSyncFenceNV( const VULKAN_HPP_NAMESPACE::ImportFenceSciSyncInfoNV & importFenceSciSyncInfo, Dispatch const & d ) const
  {
    ...
    VkResult result = d.vkImportFenceSciSyncFenceNV( m_device, reinterpret_cast<const VkImportFenceSciSyncInfoNV *>( &importFenceSciSyncInfo ) );
    resultCheck( static_cast<VULKAN_HPP_NAMESPACE::Result>( result ), VULKAN_HPP_NAMESPACE_STRING "::Device::importFenceSciSyncFenceNV" );
...
#  ifndef VULKAN_HPP_DISABLE_ENHANCED_MODE
    ...
    Device::importFenceSciSyncObjNV( const VULKAN_HPP_NAMESPACE::ImportFenceSciSyncInfoNV & importFenceSciSyncInfo, Dispatch const & d ) const
  {
    ...
    VkResult result = d.vkImportFenceSciSyncObjNV( m_device, reinterpret_cast<const VkImportFenceSciSyncInfoNV *>( &importFenceSciSyncInfo ) );
    resultCheck( static_cast<VULKAN_HPP_NAMESPACE::Result>( result ), VULKAN_HPP_NAMESPACE_STRING "::Device::importFenceSciSyncObjNV" );
...
#  ifndef VULKAN_HPP_DISABLE_ENHANCED_MODE
    ...
    const VULKAN_HPP_NAMESPACE::SciSyncAttributesInfoNV & sciSyncAttributesInfo, NvSciSyncAttrList pAttributes, Dispatch const & d ) const
  {
    ...
    VkResult result =
      d.vkGetPhysicalDeviceSciSyncAttributesNV( m_physicalDevice, reinterpret_cast<const VkSciSyncAttributesInfoNV *>( &sciSyncAttributesInfo ), pAttributes );
    resultCheck( static_cast<VULKAN_HPP_NAMESPACE::Result>( result ), VULKAN_HPP_NAMESPACE_STRING "::PhysicalDevice::getSciSyncAttributesNV" );
...
#  ifndef VULKAN_HPP_DISABLE_ENHANCED_MODE
                       ...
                       Device::getSemaphoreSciSyncObjNV( const VULKAN_HPP_NAMESPACE::SemaphoreGetSciSyncInfoNV & getSciSyncInfo, Dispatch const & d ) const
  {
    ...
    HandleType handle;
    VkResult   result = d.vkGetSemaphoreSciSyncObjNV( m_device, reinterpret_cast<const VkSemaphoreGetSciSyncInfoNV *>( &getSciSyncInfo ), &handle );
    resultCheck( static_cast<VULKAN_HPP_NAMESPACE::Result>( result ), VULKAN_HPP_NAMESPACE_STRING "::Device::getSemaphoreSciSyncObjNV" );
...
#  ifndef VULKAN_HPP_DISABLE_ENHANCED_MODE
    ...
    Device::importSemaphoreSciSyncObjNV( const VULKAN_HPP_NAMESPACE::ImportSemaphoreSciSyncInfoNV & importSemaphoreSciSyncInfo, Dispatch const & d ) const
  {
    ...
    VkResult result = d.vkImportSemaphoreSciSyncObjNV( m_device, reinterpret_cast<const VkImportSemaphoreSciSyncInfoNV *>( &importSemaphoreSciSyncInfo ) );
    resultCheck( static_cast<VULKAN_HPP_NAMESPACE::Result>( result ), VULKAN_HPP_NAMESPACE_STRING "::Device::importSemaphoreSciSyncObjNV" );
...
#  ifndef VULKAN_HPP_DISABLE_ENHANCED_MODE
                       ...
                       Device::getMemorySciBufNV( const VULKAN_HPP_NAMESPACE::MemoryGetSciBufInfoNV & getSciBufInfo, Dispatch const & d ) const
  {
    ...
    NvSciBufObj handle;
    VkResult    result = d.vkGetMemorySciBufNV( m_device, reinterpret_cast<const VkMemoryGetSciBufInfoNV *>( &getSciBufInfo ), &handle );
    resultCheck( static_cast<VULKAN_HPP_NAMESPACE::Result>( result ), VULKAN_HPP_NAMESPACE_STRING "::Device::getMemorySciBufNV" );
...
#  ifndef VULKAN_HPP_DISABLE_ENHANCED_MODE
                                                         ...
                                                         Dispatch const &                                       d ) const
  {
    ...
    VkResult                                       result = d.vkGetPhysicalDeviceExternalMemorySciBufPropertiesNV( m_physicalDevice,
                                                                             static_cast<VkExternalMemoryHandleTypeFlagBits>( handleType ),
                                                                             handle,
                                                                             reinterpret_cast<VkMemorySciBufPropertiesNV *>( &memorySciBufProperties ) );
    resultCheck( static_cast<VULKAN_HPP_NAMESPACE::Result>( result ), VULKAN_HPP_NAMESPACE_STRING "::PhysicalDevice::getExternalMemorySciBufPropertiesNV" );

    return createResultValueType( static_cast<VULKAN_HPP_NAMESPACE::Result>( result ), memorySciBufProperties );
  }
#  endif /* VULKAN_HPP_DISABLE_ENHANCED_MODE */
...
#  else
    ...
    PhysicalDevice::getSciBufAttributesNV( NvSciBufAttrList pAttributes, Dispatch const & d ) const
  {
    ...
    VkResult result = d.vkGetPhysicalDeviceSciBufAttributesNV( m_physicalDevice, pAttributes );
    resultCheck( static_cast<VULKAN_HPP_NAMESPACE::Result>( result ), VULKAN_HPP_NAMESPACE_STRING "::PhysicalDevice::getSciBufAttributesNV" );
...
#  ifndef VULKAN_HPP_DISABLE_ENHANCED_MODE
                                          ...
                                          Dispatch const &                                               d ) const
  {
    ...
    VkResult                                     result = d.vkCreateSemaphoreSciSyncPoolNV(
      m_device,
    ...
    resultCheck( static_cast<VULKAN_HPP_NAMESPACE::Result>( result ), VULKAN_HPP_NAMESPACE_STRING "::Device::createSemaphoreSciSyncPoolNV" );

    return createResultValueType( static_cast<VULKAN_HPP_NAMESPACE::Result>( result ), semaphorePool );
  }
...
#    ifndef VULKAN_HPP_NO_SMART_HANDLE
                                                ...
                                                Dispatch const &                                               d ) const
  {
    ...
    VkResult                                     result = d.vkCreateSemaphoreSciSyncPoolNV(
      ...
      reinterpret_cast<const VkAllocationCallbacks *>( static_cast<const VULKAN_HPP_NAMESPACE::AllocationCallbacks *>( allocator ) ),
      reinterpret_cast<VkSemaphoreSciSyncPoolNV *>( &semaphorePool ) );
    resultCheck( static_cast<VULKAN_HPP_NAMESPACE::Result>( result ), VULKAN_HPP_NAMESPACE_STRING "::Device::createSemaphoreSciSyncPoolNVUnique" );

    return createResultValueType(
      static_cast<VULKAN_HPP_NAMESPACE::Result>( result ),
      UniqueHandle<VULKAN_HPP_NAMESPACE::SemaphoreSciSyncPoolNV, Dispatch>( semaphorePool, ObjectDestroy<Device, Dispatch>( *this, allocator, d ) ) );
  }
#    endif /* VULKAN_HPP_NO_SMART_HANDLE */
#  endif   /* VULKAN_HPP_DISABLE_ENHANCED_MODE */
#endif     /*VK_USE_PLATFORM_SCI*/
