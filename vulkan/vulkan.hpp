...
#  endif
  ...
  VULKAN_HPP_CONSTEXPR_INLINE auto SurfaceKHRExtName          = VK_KHR_SURFACE_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto SwapchainKHRExtName        = VK_KHR_SWAPCHAIN_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto DisplayKHRExtName          = VK_KHR_DISPLAY_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto DisplaySwapchainKHRExtName = VK_KHR_DISPLAY_SWAPCHAIN_EXTENSION_NAME;

#if defined( VK_USE_PLATFORM_XLIB_KHR )
  VULKAN_HPP_CONSTEXPR_INLINE auto XlibSurfaceKHRExtName = VK_KHR_XLIB_SURFACE_EXTENSION_NAME;
#endif /*VK_USE_PLATFORM_XLIB_KHR*/

#if defined( VK_USE_PLATFORM_XCB_KHR )
  VULKAN_HPP_CONSTEXPR_INLINE auto XcbSurfaceKHRExtName = VK_KHR_XCB_SURFACE_EXTENSION_NAME;
#endif /*VK_USE_PLATFORM_XCB_KHR*/

#if defined( VK_USE_PLATFORM_WAYLAND_KHR )
  VULKAN_HPP_CONSTEXPR_INLINE auto WaylandSurfaceKHRExtName = VK_KHR_WAYLAND_SURFACE_EXTENSION_NAME;
#endif /*VK_USE_PLATFORM_WAYLAND_KHR*/

#if defined( VK_USE_PLATFORM_ANDROID_KHR )
  VULKAN_HPP_CONSTEXPR_INLINE auto AndroidSurfaceKHRExtName = VK_KHR_ANDROID_SURFACE_EXTENSION_NAME;
#endif /*VK_USE_PLATFORM_ANDROID_KHR*/

#if defined( VK_USE_PLATFORM_WIN32_KHR )
  VULKAN_HPP_CONSTEXPR_INLINE auto Win32SurfaceKHRExtName = VK_KHR_WIN32_SURFACE_EXTENSION_NAME;
#endif /*VK_USE_PLATFORM_WIN32_KHR*/

  VULKAN_HPP_DEPRECATED( "The VK_EXT_debug_report extension has been deprecated by VK_EXT_debug_utils." )
  VULKAN_HPP_CONSTEXPR_INLINE auto DebugReportEXTExtName = VK_EXT_DEBUG_REPORT_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_NV_glsl_shader extension has been deprecated." )
  VULKAN_HPP_CONSTEXPR_INLINE auto GlslShaderNVExtName              = VK_NV_GLSL_SHADER_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto DepthRangeUnrestrictedEXTExtName = VK_EXT_DEPTH_RANGE_UNRESTRICTED_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_KHR_sampler_mirror_clamp_to_edge extension has been promoted to core in version 1.2." )
  VULKAN_HPP_CONSTEXPR_INLINE auto SamplerMirrorClampToEdgeKHRExtName      = VK_KHR_SAMPLER_MIRROR_CLAMP_TO_EDGE_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto FilterCubicIMGExtName                   = VK_IMG_FILTER_CUBIC_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto RasterizationOrderAMDExtName            = VK_AMD_RASTERIZATION_ORDER_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto ShaderTrinaryMinmaxAMDExtName           = VK_AMD_SHADER_TRINARY_MINMAX_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto ShaderExplicitVertexParameterAMDExtName = VK_AMD_SHADER_EXPLICIT_VERTEX_PARAMETER_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_EXT_debug_marker extension has been promoted to VK_EXT_debug_utils." )
  VULKAN_HPP_CONSTEXPR_INLINE auto DebugMarkerEXTExtName      = VK_EXT_DEBUG_MARKER_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto VideoQueueKHRExtName       = VK_KHR_VIDEO_QUEUE_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto VideoDecodeQueueKHRExtName = VK_KHR_VIDEO_DECODE_QUEUE_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto GcnShaderAMDExtName        = VK_AMD_GCN_SHADER_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_NV_dedicated_allocation extension has been deprecated by VK_KHR_dedicated_allocation." )
  VULKAN_HPP_CONSTEXPR_INLINE auto DedicatedAllocationNVExtName = VK_NV_DEDICATED_ALLOCATION_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto TransformFeedbackEXTExtName  = VK_EXT_TRANSFORM_FEEDBACK_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto BinaryImportNVXExtName       = VK_NVX_BINARY_IMPORT_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto ImageViewHandleNVXExtName    = VK_NVX_IMAGE_VIEW_HANDLE_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_AMD_draw_indirect_count extension has been promoted to VK_KHR_draw_indirect_count." )
  VULKAN_HPP_CONSTEXPR_INLINE auto DrawIndirectCountAMDExtName = VK_AMD_DRAW_INDIRECT_COUNT_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_AMD_negative_viewport_height extension has been obsoleted by VK_KHR_maintenance1." )
  VULKAN_HPP_CONSTEXPR_INLINE auto NegativeViewportHeightAMDExtName = VK_AMD_NEGATIVE_VIEWPORT_HEIGHT_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_AMD_gpu_shader_half_float extension has been deprecated by VK_KHR_shader_float16_int8." )
  VULKAN_HPP_CONSTEXPR_INLINE auto GpuShaderHalfFloatAMDExtName = VK_AMD_GPU_SHADER_HALF_FLOAT_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto ShaderBallotAMDExtName       = VK_AMD_SHADER_BALLOT_EXTENSION_NAME;

#if defined( VK_ENABLE_BETA_EXTENSIONS )
  VULKAN_HPP_CONSTEXPR_INLINE auto VideoEncodeH264EXTExtName = VK_EXT_VIDEO_ENCODE_H264_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto VideoEncodeH265EXTExtName = VK_EXT_VIDEO_ENCODE_H265_EXTENSION_NAME;
#endif /*VK_ENABLE_BETA_EXTENSIONS*/

  VULKAN_HPP_CONSTEXPR_INLINE auto VideoDecodeH264KHRExtName      = VK_KHR_VIDEO_DECODE_H264_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto TextureGatherBiasLodAMDExtName = VK_AMD_TEXTURE_GATHER_BIAS_LOD_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto ShaderInfoAMDExtName           = VK_AMD_SHADER_INFO_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_KHR_dynamic_rendering extension has been promoted to core in version 1.3." )
  VULKAN_HPP_CONSTEXPR_INLINE auto DynamicRenderingKHRExtName        = VK_KHR_DYNAMIC_RENDERING_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto ShaderImageLoadStoreLodAMDExtName = VK_AMD_SHADER_IMAGE_LOAD_STORE_LOD_EXTENSION_NAME;

#if defined( VK_USE_PLATFORM_GGP )
  VULKAN_HPP_CONSTEXPR_INLINE auto StreamDescriptorSurfaceGGPExtName = VK_GGP_STREAM_DESCRIPTOR_SURFACE_EXTENSION_NAME;
#endif /*VK_USE_PLATFORM_GGP*/

  VULKAN_HPP_CONSTEXPR_INLINE auto CornerSampledImageNVExtName = VK_NV_CORNER_SAMPLED_IMAGE_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_KHR_multiview extension has been promoted to core in version 1.1." )
  VULKAN_HPP_CONSTEXPR_INLINE auto MultiviewKHRExtName = VK_KHR_MULTIVIEW_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_IMG_format_pvrtc extension has been deprecated." )
  VULKAN_HPP_CONSTEXPR_INLINE auto FormatPvrtcIMGExtName = VK_IMG_FORMAT_PVRTC_EXTENSION_NAME;
  ...
  VULKAN_HPP_CONSTEXPR_INLINE auto ExternalMemoryCapabilitiesNVExtName = VK_NV_EXTERNAL_MEMORY_CAPABILITIES_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_NV_external_memory extension has been deprecated by VK_KHR_external_memory." )
  VULKAN_HPP_CONSTEXPR_INLINE auto ExternalMemoryNVExtName = VK_NV_EXTERNAL_MEMORY_EXTENSION_NAME;

#if defined( VK_USE_PLATFORM_WIN32_KHR )
  VULKAN_HPP_DEPRECATED( "The VK_NV_external_memory_win32 extension has been deprecated by VK_KHR_external_memory_win32." )
  VULKAN_HPP_CONSTEXPR_INLINE auto ExternalMemoryWin32NVExtName = VK_NV_EXTERNAL_MEMORY_WIN32_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_NV_win32_keyed_mutex extension has been promoted to VK_KHR_win32_keyed_mutex." )
  VULKAN_HPP_CONSTEXPR_INLINE auto Win32KeyedMutexNVExtName = VK_NV_WIN32_KEYED_MUTEX_EXTENSION_NAME;
#endif /*VK_USE_PLATFORM_WIN32_KHR*/

  VULKAN_HPP_DEPRECATED( "The VK_KHR_get_physical_device_properties2 extension has been promoted to core in version 1.1." )
  VULKAN_HPP_CONSTEXPR_INLINE auto GetPhysicalDeviceProperties2KHRExtName = VK_KHR_GET_PHYSICAL_DEVICE_PROPERTIES_2_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_KHR_device_group extension has been promoted to core in version 1.1." )
  VULKAN_HPP_CONSTEXPR_INLINE auto DeviceGroupKHRExtName = VK_KHR_DEVICE_GROUP_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_EXT_validation_flags extension has been deprecated by VK_EXT_validation_features." )
  VULKAN_HPP_CONSTEXPR_INLINE auto ValidationFlagsEXTExtName = VK_EXT_VALIDATION_FLAGS_EXTENSION_NAME;

#if defined( VK_USE_PLATFORM_VI_NN )
  VULKAN_HPP_CONSTEXPR_INLINE auto ViSurfaceNNExtName = VK_NN_VI_SURFACE_EXTENSION_NAME;
#endif /*VK_USE_PLATFORM_VI_NN*/

  VULKAN_HPP_DEPRECATED( "The VK_KHR_shader_draw_parameters extension has been promoted to core in version 1.1." )
  VULKAN_HPP_CONSTEXPR_INLINE auto ShaderDrawParametersKHRExtName = VK_KHR_SHADER_DRAW_PARAMETERS_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_EXT_shader_subgroup_ballot extension has been deprecated by VK_VERSION_1_2." )
  VULKAN_HPP_CONSTEXPR_INLINE auto ShaderSubgroupBallotEXTExtName = VK_EXT_SHADER_SUBGROUP_BALLOT_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_EXT_shader_subgroup_vote extension has been deprecated by VK_VERSION_1_1." )
  VULKAN_HPP_CONSTEXPR_INLINE auto ShaderSubgroupVoteEXTExtName = VK_EXT_SHADER_SUBGROUP_VOTE_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_EXT_texture_compression_astc_hdr extension has been promoted to core in version 1.3." )
  VULKAN_HPP_CONSTEXPR_INLINE auto TextureCompressionAstcHdrEXTExtName = VK_EXT_TEXTURE_COMPRESSION_ASTC_HDR_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto AstcDecodeModeEXTExtName            = VK_EXT_ASTC_DECODE_MODE_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto PipelineRobustnessEXTExtName        = VK_EXT_PIPELINE_ROBUSTNESS_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_KHR_maintenance1 extension has been promoted to core in version 1.1." )
  VULKAN_HPP_CONSTEXPR_INLINE auto Maintenance1KHRExtName = VK_KHR_MAINTENANCE_1_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_KHR_device_group_creation extension has been promoted to core in version 1.1." )
  VULKAN_HPP_CONSTEXPR_INLINE auto DeviceGroupCreationKHRExtName = VK_KHR_DEVICE_GROUP_CREATION_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_KHR_external_memory_capabilities extension has been promoted to core in version 1.1." )
  VULKAN_HPP_CONSTEXPR_INLINE auto ExternalMemoryCapabilitiesKHRExtName = VK_KHR_EXTERNAL_MEMORY_CAPABILITIES_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_KHR_external_memory extension has been promoted to core in version 1.1." )
  VULKAN_HPP_CONSTEXPR_INLINE auto ExternalMemoryKHRExtName = VK_KHR_EXTERNAL_MEMORY_EXTENSION_NAME;

#if defined( VK_USE_PLATFORM_WIN32_KHR )
  VULKAN_HPP_CONSTEXPR_INLINE auto ExternalMemoryWin32KHRExtName = VK_KHR_EXTERNAL_MEMORY_WIN32_EXTENSION_NAME;
#endif /*VK_USE_PLATFORM_WIN32_KHR*/

  VULKAN_HPP_CONSTEXPR_INLINE auto ExternalMemoryFdKHRExtName = VK_KHR_EXTERNAL_MEMORY_FD_EXTENSION_NAME;

#if defined( VK_USE_PLATFORM_WIN32_KHR )
  VULKAN_HPP_CONSTEXPR_INLINE auto Win32KeyedMutexKHRExtName = VK_KHR_WIN32_KEYED_MUTEX_EXTENSION_NAME;
#endif /*VK_USE_PLATFORM_WIN32_KHR*/

  VULKAN_HPP_DEPRECATED( "The VK_KHR_external_semaphore_capabilities extension has been promoted to core in version 1.1." )
  VULKAN_HPP_CONSTEXPR_INLINE auto ExternalSemaphoreCapabilitiesKHRExtName = VK_KHR_EXTERNAL_SEMAPHORE_CAPABILITIES_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_KHR_external_semaphore extension has been promoted to core in version 1.1." )
  VULKAN_HPP_CONSTEXPR_INLINE auto ExternalSemaphoreKHRExtName = VK_KHR_EXTERNAL_SEMAPHORE_EXTENSION_NAME;

#if defined( VK_USE_PLATFORM_WIN32_KHR )
  VULKAN_HPP_CONSTEXPR_INLINE auto ExternalSemaphoreWin32KHRExtName = VK_KHR_EXTERNAL_SEMAPHORE_WIN32_EXTENSION_NAME;
#endif /*VK_USE_PLATFORM_WIN32_KHR*/

  VULKAN_HPP_CONSTEXPR_INLINE auto ExternalSemaphoreFdKHRExtName  = VK_KHR_EXTERNAL_SEMAPHORE_FD_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto PushDescriptorKHRExtName       = VK_KHR_PUSH_DESCRIPTOR_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto ConditionalRenderingEXTExtName = VK_EXT_CONDITIONAL_RENDERING_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_KHR_shader_float16_int8 extension has been promoted to core in version 1.2." )
  VULKAN_HPP_CONSTEXPR_INLINE auto ShaderFloat16Int8KHRExtName = VK_KHR_SHADER_FLOAT16_INT8_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_KHR_16bit_storage extension has been promoted to core in version 1.1." )
  VULKAN_HPP_CONSTEXPR_INLINE auto 16BitStorageKHRExtName       = VK_KHR_16BIT_STORAGE_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto IncrementalPresentKHRExtName = VK_KHR_INCREMENTAL_PRESENT_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_KHR_descriptor_update_template extension has been promoted to core in version 1.1." )
  VULKAN_HPP_CONSTEXPR_INLINE auto DescriptorUpdateTemplateKHRExtName = VK_KHR_DESCRIPTOR_UPDATE_TEMPLATE_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto ClipSpaceWScalingNVExtName         = VK_NV_CLIP_SPACE_W_SCALING_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto DirectModeDisplayEXTExtName        = VK_EXT_DIRECT_MODE_DISPLAY_EXTENSION_NAME;

#if defined( VK_USE_PLATFORM_XLIB_XRANDR_EXT )
  VULKAN_HPP_CONSTEXPR_INLINE auto AcquireXlibDisplayEXTExtName = VK_EXT_ACQUIRE_XLIB_DISPLAY_EXTENSION_NAME;
#endif /*VK_USE_PLATFORM_XLIB_XRANDR_EXT*/

  VULKAN_HPP_CONSTEXPR_INLINE auto DisplaySurfaceCounterEXTExtName      = VK_EXT_DISPLAY_SURFACE_COUNTER_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto DisplayControlEXTExtName             = VK_EXT_DISPLAY_CONTROL_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto DisplayTimingGOOGLEExtName           = VK_GOOGLE_DISPLAY_TIMING_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto SampleMaskOverrideCoverageNVExtName  = VK_NV_SAMPLE_MASK_OVERRIDE_COVERAGE_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto GeometryShaderPassthroughNVExtName   = VK_NV_GEOMETRY_SHADER_PASSTHROUGH_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto ViewportArray2NVExtName              = VK_NV_VIEWPORT_ARRAY_2_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto MultiviewPerViewAttributesNVXExtName = VK_NVX_MULTIVIEW_PER_VIEW_ATTRIBUTES_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto ViewportSwizzleNVExtName             = VK_NV_VIEWPORT_SWIZZLE_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto DiscardRectanglesEXTExtName          = VK_EXT_DISCARD_RECTANGLES_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto ConservativeRasterizationEXTExtName  = VK_EXT_CONSERVATIVE_RASTERIZATION_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto DepthClipEnableEXTExtName            = VK_EXT_DEPTH_CLIP_ENABLE_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto SwapchainColorSpaceEXTExtName        = VK_EXT_SWAPCHAIN_COLOR_SPACE_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto HdrMetadataEXTExtName                = VK_EXT_HDR_METADATA_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_KHR_imageless_framebuffer extension has been promoted to core in version 1.2." )
  VULKAN_HPP_CONSTEXPR_INLINE auto ImagelessFramebufferKHRExtName = VK_KHR_IMAGELESS_FRAMEBUFFER_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_KHR_create_renderpass2 extension has been promoted to core in version 1.2." )
  VULKAN_HPP_CONSTEXPR_INLINE auto CreateRenderpass2KHRExtName      = VK_KHR_CREATE_RENDERPASS_2_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto SharedPresentableImageKHRExtName = VK_KHR_SHARED_PRESENTABLE_IMAGE_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_KHR_external_fence_capabilities extension has been promoted to core in version 1.1." )
  VULKAN_HPP_CONSTEXPR_INLINE auto ExternalFenceCapabilitiesKHRExtName = VK_KHR_EXTERNAL_FENCE_CAPABILITIES_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_KHR_external_fence extension has been promoted to core in version 1.1." )
  VULKAN_HPP_CONSTEXPR_INLINE auto ExternalFenceKHRExtName = VK_KHR_EXTERNAL_FENCE_EXTENSION_NAME;

#if defined( VK_USE_PLATFORM_WIN32_KHR )
  VULKAN_HPP_CONSTEXPR_INLINE auto ExternalFenceWin32KHRExtName = VK_KHR_EXTERNAL_FENCE_WIN32_EXTENSION_NAME;
#endif /*VK_USE_PLATFORM_WIN32_KHR*/

  VULKAN_HPP_CONSTEXPR_INLINE auto ExternalFenceFdKHRExtName  = VK_KHR_EXTERNAL_FENCE_FD_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto PerformanceQueryKHRExtName = VK_KHR_PERFORMANCE_QUERY_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_KHR_maintenance2 extension has been promoted to core in version 1.1." )
  VULKAN_HPP_CONSTEXPR_INLINE auto Maintenance2KHRExtName            = VK_KHR_MAINTENANCE_2_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto GetSurfaceCapabilities2KHRExtName = VK_KHR_GET_SURFACE_CAPABILITIES_2_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_KHR_variable_pointers extension has been promoted to core in version 1.1." )
  VULKAN_HPP_CONSTEXPR_INLINE auto VariablePointersKHRExtName      = VK_KHR_VARIABLE_POINTERS_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto GetDisplayProperties2KHRExtName = VK_KHR_GET_DISPLAY_PROPERTIES_2_EXTENSION_NAME;

#if defined( VK_USE_PLATFORM_IOS_MVK )
  VULKAN_HPP_DEPRECATED( "The VK_MVK_ios_surface extension has been deprecated by VK_EXT_metal_surface." )
  VULKAN_HPP_CONSTEXPR_INLINE auto IosSurfaceMVKExtName = VK_MVK_IOS_SURFACE_EXTENSION_NAME;
#endif /*VK_USE_PLATFORM_IOS_MVK*/

#if defined( VK_USE_PLATFORM_MACOS_MVK )
  VULKAN_HPP_DEPRECATED( "The VK_MVK_macos_surface extension has been deprecated by VK_EXT_metal_surface." )
  VULKAN_HPP_CONSTEXPR_INLINE auto MacosSurfaceMVKExtName = VK_MVK_MACOS_SURFACE_EXTENSION_NAME;
#endif /*VK_USE_PLATFORM_MACOS_MVK*/

  VULKAN_HPP_CONSTEXPR_INLINE auto ExternalMemoryDmaBufEXTExtName = VK_EXT_EXTERNAL_MEMORY_DMA_BUF_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto QueueFamilyForeignEXTExtName   = VK_EXT_QUEUE_FAMILY_FOREIGN_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_KHR_dedicated_allocation extension has been promoted to core in version 1.1." )
  VULKAN_HPP_CONSTEXPR_INLINE auto DedicatedAllocationKHRExtName = VK_KHR_DEDICATED_ALLOCATION_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto DebugUtilsEXTExtName          = VK_EXT_DEBUG_UTILS_EXTENSION_NAME;

#if defined( VK_USE_PLATFORM_ANDROID_KHR )
  VULKAN_HPP_CONSTEXPR_INLINE auto ExternalMemoryAndroidHardwareBufferANDROIDExtName = VK_ANDROID_EXTERNAL_MEMORY_ANDROID_HARDWARE_BUFFER_EXTENSION_NAME;
#endif /*VK_USE_PLATFORM_ANDROID_KHR*/

  VULKAN_HPP_DEPRECATED( "The VK_EXT_sampler_filter_minmax extension has been promoted to core in version 1.2." )
  VULKAN_HPP_CONSTEXPR_INLINE auto SamplerFilterMinmaxEXTExtName = VK_EXT_SAMPLER_FILTER_MINMAX_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_KHR_storage_buffer_storage_class extension has been promoted to core in version 1.1." )
  VULKAN_HPP_CONSTEXPR_INLINE auto StorageBufferStorageClassKHRExtName = VK_KHR_STORAGE_BUFFER_STORAGE_CLASS_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_AMD_gpu_shader_int16 extension has been deprecated by VK_KHR_shader_float16_int8." )
  VULKAN_HPP_CONSTEXPR_INLINE auto GpuShaderInt16AMDExtName = VK_AMD_GPU_SHADER_INT16_EXTENSION_NAME;

#if defined( VK_ENABLE_BETA_EXTENSIONS )
  VULKAN_HPP_CONSTEXPR_INLINE auto ShaderEnqueueAMDXExtName = VK_AMDX_SHADER_ENQUEUE_EXTENSION_NAME;
#endif /*VK_ENABLE_BETA_EXTENSIONS*/

  VULKAN_HPP_CONSTEXPR_INLINE auto MixedAttachmentSamplesAMDExtName = VK_AMD_MIXED_ATTACHMENT_SAMPLES_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto ShaderFragmentMaskAMDExtName     = VK_AMD_SHADER_FRAGMENT_MASK_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_EXT_inline_uniform_block extension has been promoted to core in version 1.3." )
  VULKAN_HPP_CONSTEXPR_INLINE auto InlineUniformBlockEXTExtName  = VK_EXT_INLINE_UNIFORM_BLOCK_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto ShaderStencilExportEXTExtName = VK_EXT_SHADER_STENCIL_EXPORT_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto SampleLocationsEXTExtName     = VK_EXT_SAMPLE_LOCATIONS_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_KHR_relaxed_block_layout extension has been promoted to core in version 1.1." )
  VULKAN_HPP_CONSTEXPR_INLINE auto RelaxedBlockLayoutKHRExtName = VK_KHR_RELAXED_BLOCK_LAYOUT_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_KHR_get_memory_requirements2 extension has been promoted to core in version 1.1." )
  VULKAN_HPP_CONSTEXPR_INLINE auto GetMemoryRequirements2KHRExtName = VK_KHR_GET_MEMORY_REQUIREMENTS_2_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_KHR_image_format_list extension has been promoted to core in version 1.2." )
  VULKAN_HPP_CONSTEXPR_INLINE auto ImageFormatListKHRExtName        = VK_KHR_IMAGE_FORMAT_LIST_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto BlendOperationAdvancedEXTExtName = VK_EXT_BLEND_OPERATION_ADVANCED_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto FragmentCoverageToColorNVExtName = VK_NV_FRAGMENT_COVERAGE_TO_COLOR_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto AccelerationStructureKHRExtName  = VK_KHR_ACCELERATION_STRUCTURE_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto RayTracingPipelineKHRExtName     = VK_KHR_RAY_TRACING_PIPELINE_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto RayQueryKHRExtName               = VK_KHR_RAY_QUERY_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto FramebufferMixedSamplesNVExtName = VK_NV_FRAMEBUFFER_MIXED_SAMPLES_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto FillRectangleNVExtName           = VK_NV_FILL_RECTANGLE_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto ShaderSmBuiltinsNVExtName        = VK_NV_SHADER_SM_BUILTINS_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto PostDepthCoverageEXTExtName      = VK_EXT_POST_DEPTH_COVERAGE_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_KHR_sampler_ycbcr_conversion extension has been promoted to core in version 1.1." )
  VULKAN_HPP_CONSTEXPR_INLINE auto SamplerYcbcrConversionKHRExtName = VK_KHR_SAMPLER_YCBCR_CONVERSION_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_KHR_bind_memory2 extension has been promoted to core in version 1.1." )
  VULKAN_HPP_CONSTEXPR_INLINE auto BindMemory2KHRExtName            = VK_KHR_BIND_MEMORY_2_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto ImageDrmFormatModifierEXTExtName = VK_EXT_IMAGE_DRM_FORMAT_MODIFIER_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto ValidationCacheEXTExtName        = VK_EXT_VALIDATION_CACHE_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_EXT_descriptor_indexing extension has been promoted to core in version 1.2." )
  VULKAN_HPP_CONSTEXPR_INLINE auto DescriptorIndexingEXTExtName = VK_EXT_DESCRIPTOR_INDEXING_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_EXT_shader_viewport_index_layer extension has been promoted to core in version 1.2." )
  VULKAN_HPP_CONSTEXPR_INLINE auto ShaderViewportIndexLayerEXTExtName = VK_EXT_SHADER_VIEWPORT_INDEX_LAYER_EXTENSION_NAME;

#if defined( VK_ENABLE_BETA_EXTENSIONS )
  VULKAN_HPP_CONSTEXPR_INLINE auto PortabilitySubsetKHRExtName = VK_KHR_PORTABILITY_SUBSET_EXTENSION_NAME;
#endif /*VK_ENABLE_BETA_EXTENSIONS*/

  VULKAN_HPP_CONSTEXPR_INLINE auto ShadingRateImageNVExtName           = VK_NV_SHADING_RATE_IMAGE_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto RayTracingNVExtName                 = VK_NV_RAY_TRACING_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto RepresentativeFragmentTestNVExtName = VK_NV_REPRESENTATIVE_FRAGMENT_TEST_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_KHR_maintenance3 extension has been promoted to core in version 1.1." )
  VULKAN_HPP_CONSTEXPR_INLINE auto Maintenance3KHRExtName = VK_KHR_MAINTENANCE_3_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_KHR_draw_indirect_count extension has been promoted to core in version 1.2." )
  VULKAN_HPP_CONSTEXPR_INLINE auto DrawIndirectCountKHRExtName        = VK_KHR_DRAW_INDIRECT_COUNT_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto FilterCubicEXTExtName              = VK_EXT_FILTER_CUBIC_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto RenderPassShaderResolveQCOMExtName = VK_QCOM_RENDER_PASS_SHADER_RESOLVE_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_EXT_global_priority extension has been promoted to VK_KHR_global_priority." )
  VULKAN_HPP_CONSTEXPR_INLINE auto GlobalPriorityEXTExtName = VK_EXT_GLOBAL_PRIORITY_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_KHR_shader_subgroup_extended_types extension has been promoted to core in version 1.2." )
  VULKAN_HPP_CONSTEXPR_INLINE auto ShaderSubgroupExtendedTypesKHRExtName = VK_KHR_SHADER_SUBGROUP_EXTENDED_TYPES_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_KHR_8bit_storage extension has been promoted to core in version 1.2." )
  VULKAN_HPP_CONSTEXPR_INLINE auto 8BitStorageKHRExtName        = VK_KHR_8BIT_STORAGE_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto ExternalMemoryHostEXTExtName = VK_EXT_EXTERNAL_MEMORY_HOST_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto BufferMarkerAMDExtName       = VK_AMD_BUFFER_MARKER_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_KHR_shader_atomic_int64 extension has been promoted to core in version 1.2." )
  VULKAN_HPP_CONSTEXPR_INLINE auto ShaderAtomicInt64KHRExtName            = VK_KHR_SHADER_ATOMIC_INT64_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto ShaderClockKHRExtName                  = VK_KHR_SHADER_CLOCK_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto PipelineCompilerControlAMDExtName      = VK_AMD_PIPELINE_COMPILER_CONTROL_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto CalibratedTimestampsEXTExtName         = VK_EXT_CALIBRATED_TIMESTAMPS_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto ShaderCorePropertiesAMDExtName         = VK_AMD_SHADER_CORE_PROPERTIES_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto VideoDecodeH265KHRExtName              = VK_KHR_VIDEO_DECODE_H265_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto GlobalPriorityKHRExtName               = VK_KHR_GLOBAL_PRIORITY_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto MemoryOverallocationBehaviorAMDExtName = VK_AMD_MEMORY_OVERALLOCATION_BEHAVIOR_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto VertexAttributeDivisorEXTExtName       = VK_EXT_VERTEX_ATTRIBUTE_DIVISOR_EXTENSION_NAME;

#if defined( VK_USE_PLATFORM_GGP )
  VULKAN_HPP_CONSTEXPR_INLINE auto FrameTokenGGPExtName = VK_GGP_FRAME_TOKEN_EXTENSION_NAME;
#endif /*VK_USE_PLATFORM_GGP*/

  VULKAN_HPP_DEPRECATED( "The VK_EXT_pipeline_creation_feedback extension has been promoted to core in version 1.3." )
  VULKAN_HPP_CONSTEXPR_INLINE auto PipelineCreationFeedbackEXTExtName = VK_EXT_PIPELINE_CREATION_FEEDBACK_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_KHR_driver_properties extension has been promoted to core in version 1.2." )
  VULKAN_HPP_CONSTEXPR_INLINE auto DriverPropertiesKHRExtName = VK_KHR_DRIVER_PROPERTIES_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_KHR_shader_float_controls extension has been promoted to core in version 1.2." )
  VULKAN_HPP_CONSTEXPR_INLINE auto ShaderFloatControlsKHRExtName      = VK_KHR_SHADER_FLOAT_CONTROLS_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto ShaderSubgroupPartitionedNVExtName = VK_NV_SHADER_SUBGROUP_PARTITIONED_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_KHR_depth_stencil_resolve extension has been promoted to core in version 1.2." )
  VULKAN_HPP_CONSTEXPR_INLINE auto DepthStencilResolveKHRExtName     = VK_KHR_DEPTH_STENCIL_RESOLVE_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto SwapchainMutableFormatKHRExtName  = VK_KHR_SWAPCHAIN_MUTABLE_FORMAT_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto ComputeShaderDerivativesNVExtName = VK_NV_COMPUTE_SHADER_DERIVATIVES_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto MeshShaderNVExtName               = VK_NV_MESH_SHADER_EXTENSION_NAME;
  ...
  VULKAN_HPP_CONSTEXPR_INLINE auto FragmentShaderBarycentricNVExtName   = VK_NV_FRAGMENT_SHADER_BARYCENTRIC_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto ShaderImageFootprintNVExtName        = VK_NV_SHADER_IMAGE_FOOTPRINT_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto ScissorExclusiveNVExtName            = VK_NV_SCISSOR_EXCLUSIVE_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto DeviceDiagnosticCheckpointsNVExtName = VK_NV_DEVICE_DIAGNOSTIC_CHECKPOINTS_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_KHR_timeline_semaphore extension has been promoted to core in version 1.2." )
  VULKAN_HPP_CONSTEXPR_INLINE auto TimelineSemaphoreKHRExtName         = VK_KHR_TIMELINE_SEMAPHORE_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto ShaderIntegerFunctions2INTELExtName = VK_INTEL_SHADER_INTEGER_FUNCTIONS_2_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto PerformanceQueryINTELExtName        = VK_INTEL_PERFORMANCE_QUERY_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_KHR_vulkan_memory_model extension has been promoted to core in version 1.2." )
  VULKAN_HPP_CONSTEXPR_INLINE auto VulkanMemoryModelKHRExtName = VK_KHR_VULKAN_MEMORY_MODEL_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto PciBusInfoEXTExtName        = VK_EXT_PCI_BUS_INFO_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto DisplayNativeHdrAMDExtName  = VK_AMD_DISPLAY_NATIVE_HDR_EXTENSION_NAME;

#if defined( VK_USE_PLATFORM_FUCHSIA )
  VULKAN_HPP_CONSTEXPR_INLINE auto ImagepipeSurfaceFUCHSIAExtName = VK_FUCHSIA_IMAGEPIPE_SURFACE_EXTENSION_NAME;
#endif /*VK_USE_PLATFORM_FUCHSIA*/

  VULKAN_HPP_DEPRECATED( "The VK_KHR_shader_terminate_invocation extension has been promoted to core in version 1.3." )
  VULKAN_HPP_CONSTEXPR_INLINE auto ShaderTerminateInvocationKHRExtName = VK_KHR_SHADER_TERMINATE_INVOCATION_EXTENSION_NAME;

#if defined( VK_USE_PLATFORM_METAL_EXT )
  VULKAN_HPP_CONSTEXPR_INLINE auto MetalSurfaceEXTExtName = VK_EXT_METAL_SURFACE_EXTENSION_NAME;
#endif /*VK_USE_PLATFORM_METAL_EXT*/

  VULKAN_HPP_CONSTEXPR_INLINE auto FragmentDensityMapEXTExtName = VK_EXT_FRAGMENT_DENSITY_MAP_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_EXT_scalar_block_layout extension has been promoted to core in version 1.2." )
  VULKAN_HPP_CONSTEXPR_INLINE auto ScalarBlockLayoutEXTExtName     = VK_EXT_SCALAR_BLOCK_LAYOUT_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto HlslFunctionality1GOOGLEExtName = VK_GOOGLE_HLSL_FUNCTIONALITY_1_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto DecorateStringGOOGLEExtName     = VK_GOOGLE_DECORATE_STRING_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_EXT_subgroup_size_control extension has been promoted to core in version 1.3." )
  VULKAN_HPP_CONSTEXPR_INLINE auto SubgroupSizeControlEXTExtName    = VK_EXT_SUBGROUP_SIZE_CONTROL_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto FragmentShadingRateKHRExtName    = VK_KHR_FRAGMENT_SHADING_RATE_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto ShaderCoreProperties2AMDExtName  = VK_AMD_SHADER_CORE_PROPERTIES_2_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto DeviceCoherentMemoryAMDExtName   = VK_AMD_DEVICE_COHERENT_MEMORY_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto ShaderImageAtomicInt64EXTExtName = VK_EXT_SHADER_IMAGE_ATOMIC_INT64_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_KHR_spirv_1_4 extension has been promoted to core in version 1.2." )
  VULKAN_HPP_CONSTEXPR_INLINE auto Spirv14KHRExtName                         = VK_KHR_SPIRV_1_4_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto MemoryBudgetEXTExtName                    = VK_EXT_MEMORY_BUDGET_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto MemoryPriorityEXTExtName                  = VK_EXT_MEMORY_PRIORITY_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto SurfaceProtectedCapabilitiesKHRExtName    = VK_KHR_SURFACE_PROTECTED_CAPABILITIES_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto DedicatedAllocationImageAliasingNVExtName = VK_NV_DEDICATED_ALLOCATION_IMAGE_ALIASING_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_KHR_separate_depth_stencil_layouts extension has been promoted to core in version 1.2." )
  VULKAN_HPP_CONSTEXPR_INLINE auto SeparateDepthStencilLayoutsKHRExtName = VK_KHR_SEPARATE_DEPTH_STENCIL_LAYOUTS_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_EXT_buffer_device_address extension has been deprecated by VK_KHR_buffer_device_address." )
  VULKAN_HPP_CONSTEXPR_INLINE auto BufferDeviceAddressEXTExtName = VK_EXT_BUFFER_DEVICE_ADDRESS_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_EXT_tooling_info extension has been promoted to core in version 1.3." )
  VULKAN_HPP_CONSTEXPR_INLINE auto ToolingInfoEXTExtName = VK_EXT_TOOLING_INFO_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_EXT_separate_stencil_usage extension has been promoted to core in version 1.2." )
  VULKAN_HPP_CONSTEXPR_INLINE auto SeparateStencilUsageEXTExtName    = VK_EXT_SEPARATE_STENCIL_USAGE_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto ValidationFeaturesEXTExtName      = VK_EXT_VALIDATION_FEATURES_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto PresentWaitKHRExtName             = VK_KHR_PRESENT_WAIT_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto CooperativeMatrixNVExtName        = VK_NV_COOPERATIVE_MATRIX_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto CoverageReductionModeNVExtName    = VK_NV_COVERAGE_REDUCTION_MODE_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto FragmentShaderInterlockEXTExtName = VK_EXT_FRAGMENT_SHADER_INTERLOCK_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto YcbcrImageArraysEXTExtName        = VK_EXT_YCBCR_IMAGE_ARRAYS_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_KHR_uniform_buffer_standard_layout extension has been promoted to core in version 1.2." )
  VULKAN_HPP_CONSTEXPR_INLINE auto UniformBufferStandardLayoutKHRExtName = VK_KHR_UNIFORM_BUFFER_STANDARD_LAYOUT_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto ProvokingVertexEXTExtName             = VK_EXT_PROVOKING_VERTEX_EXTENSION_NAME;

#if defined( VK_USE_PLATFORM_WIN32_KHR )
  VULKAN_HPP_CONSTEXPR_INLINE auto FullScreenExclusiveEXTExtName = VK_EXT_FULL_SCREEN_EXCLUSIVE_EXTENSION_NAME;
#endif /*VK_USE_PLATFORM_WIN32_KHR*/

  VULKAN_HPP_CONSTEXPR_INLINE auto HeadlessSurfaceEXTExtName = VK_EXT_HEADLESS_SURFACE_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_KHR_buffer_device_address extension has been promoted to core in version 1.2." )
  VULKAN_HPP_CONSTEXPR_INLINE auto BufferDeviceAddressKHRExtName = VK_KHR_BUFFER_DEVICE_ADDRESS_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto LineRasterizationEXTExtName   = VK_EXT_LINE_RASTERIZATION_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto ShaderAtomicFloatEXTExtName   = VK_EXT_SHADER_ATOMIC_FLOAT_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_EXT_host_query_reset extension has been promoted to core in version 1.2." )
  VULKAN_HPP_CONSTEXPR_INLINE auto HostQueryResetEXTExtName = VK_EXT_HOST_QUERY_RESET_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto IndexTypeUint8EXTExtName = VK_EXT_INDEX_TYPE_UINT8_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_EXT_extended_dynamic_state extension has been promoted to core in version 1.3." )
  VULKAN_HPP_CONSTEXPR_INLINE auto ExtendedDynamicStateEXTExtName         = VK_EXT_EXTENDED_DYNAMIC_STATE_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto DeferredHostOperationsKHRExtName       = VK_KHR_DEFERRED_HOST_OPERATIONS_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto PipelineExecutablePropertiesKHRExtName = VK_KHR_PIPELINE_EXECUTABLE_PROPERTIES_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto HostImageCopyEXTExtName                = VK_EXT_HOST_IMAGE_COPY_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto MapMemory2KHRExtName                   = VK_KHR_MAP_MEMORY_2_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto ShaderAtomicFloat2EXTExtName           = VK_EXT_SHADER_ATOMIC_FLOAT_2_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto SurfaceMaintenance1EXTExtName          = VK_EXT_SURFACE_MAINTENANCE_1_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto SwapchainMaintenance1EXTExtName        = VK_EXT_SWAPCHAIN_MAINTENANCE_1_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_EXT_shader_demote_to_helper_invocation extension has been promoted to core in version 1.3." )
  VULKAN_HPP_CONSTEXPR_INLINE auto ShaderDemoteToHelperInvocationEXTExtName = VK_EXT_SHADER_DEMOTE_TO_HELPER_INVOCATION_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto DeviceGeneratedCommandsNVExtName         = VK_NV_DEVICE_GENERATED_COMMANDS_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto InheritedViewportScissorNVExtName        = VK_NV_INHERITED_VIEWPORT_SCISSOR_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_KHR_shader_integer_dot_product extension has been promoted to core in version 1.3." )
  VULKAN_HPP_CONSTEXPR_INLINE auto ShaderIntegerDotProductKHRExtName = VK_KHR_SHADER_INTEGER_DOT_PRODUCT_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_EXT_texel_buffer_alignment extension has been promoted to core in version 1.3." )
  VULKAN_HPP_CONSTEXPR_INLINE auto TexelBufferAlignmentEXTExtName = VK_EXT_TEXEL_BUFFER_ALIGNMENT_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto RenderPassTransformQCOMExtName = VK_QCOM_RENDER_PASS_TRANSFORM_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto DepthBiasControlEXTExtName     = VK_EXT_DEPTH_BIAS_CONTROL_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto DeviceMemoryReportEXTExtName   = VK_EXT_DEVICE_MEMORY_REPORT_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto AcquireDrmDisplayEXTExtName    = VK_EXT_ACQUIRE_DRM_DISPLAY_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto Robustness2EXTExtName          = VK_EXT_ROBUSTNESS_2_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto CustomBorderColorEXTExtName    = VK_EXT_CUSTOM_BORDER_COLOR_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto UserTypeGOOGLEExtName          = VK_GOOGLE_USER_TYPE_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto PipelineLibraryKHRExtName      = VK_KHR_PIPELINE_LIBRARY_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto PresentBarrierNVExtName        = VK_NV_PRESENT_BARRIER_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_KHR_shader_non_semantic_info extension has been promoted to core in version 1.3." )
  VULKAN_HPP_CONSTEXPR_INLINE auto ShaderNonSemanticInfoKHRExtName = VK_KHR_SHADER_NON_SEMANTIC_INFO_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto PresentIdKHRExtName             = VK_KHR_PRESENT_ID_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_EXT_private_data extension has been promoted to core in version 1.3." )
  VULKAN_HPP_CONSTEXPR_INLINE auto PrivateDataEXTExtName = VK_EXT_PRIVATE_DATA_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_EXT_pipeline_creation_cache_control extension has been promoted to core in version 1.3." )
  VULKAN_HPP_CONSTEXPR_INLINE auto PipelineCreationCacheControlEXTExtName = VK_EXT_PIPELINE_CREATION_CACHE_CONTROL_EXTENSION_NAME;

#if defined( VK_ENABLE_BETA_EXTENSIONS )
  VULKAN_HPP_CONSTEXPR_INLINE auto VideoEncodeQueueKHRExtName = VK_KHR_VIDEO_ENCODE_QUEUE_EXTENSION_NAME;
#endif /*VK_ENABLE_BETA_EXTENSIONS*/

  VULKAN_HPP_CONSTEXPR_INLINE auto DeviceDiagnosticsConfigNVExtName = VK_NV_DEVICE_DIAGNOSTICS_CONFIG_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto RenderPassStoreOpsQCOMExtName    = VK_QCOM_RENDER_PASS_STORE_OPS_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto LowLatencyNVExtName              = VK_NV_LOW_LATENCY_EXTENSION_NAME;

#if defined( VK_USE_PLATFORM_METAL_EXT )
  VULKAN_HPP_CONSTEXPR_INLINE auto MetalObjectsEXTExtName = VK_EXT_METAL_OBJECTS_EXTENSION_NAME;
#endif /*VK_USE_PLATFORM_METAL_EXT*/

  VULKAN_HPP_DEPRECATED( "The VK_KHR_synchronization2 extension has been promoted to core in version 1.3." )
  VULKAN_HPP_CONSTEXPR_INLINE auto Synchronization2KHRExtName                 = VK_KHR_SYNCHRONIZATION_2_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto DescriptorBufferEXTExtName                 = VK_EXT_DESCRIPTOR_BUFFER_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto GraphicsPipelineLibraryEXTExtName          = VK_EXT_GRAPHICS_PIPELINE_LIBRARY_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto ShaderEarlyAndLateFragmentTestsAMDExtName  = VK_AMD_SHADER_EARLY_AND_LATE_FRAGMENT_TESTS_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto FragmentShaderBarycentricKHRExtName        = VK_KHR_FRAGMENT_SHADER_BARYCENTRIC_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto ShaderSubgroupUniformControlFlowKHRExtName = VK_KHR_SHADER_SUBGROUP_UNIFORM_CONTROL_FLOW_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_KHR_zero_initialize_workgroup_memory extension has been promoted to core in version 1.3." )
  VULKAN_HPP_CONSTEXPR_INLINE auto ZeroInitializeWorkgroupMemoryKHRExtName = VK_KHR_ZERO_INITIALIZE_WORKGROUP_MEMORY_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto FragmentShadingRateEnumsNVExtName       = VK_NV_FRAGMENT_SHADING_RATE_ENUMS_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto RayTracingMotionBlurNVExtName           = VK_NV_RAY_TRACING_MOTION_BLUR_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto MeshShaderEXTExtName                    = VK_EXT_MESH_SHADER_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_EXT_ycbcr_2plane_444_formats extension has been promoted to core in version 1.3." )
  VULKAN_HPP_CONSTEXPR_INLINE auto Ycbcr2Plane444FormatsEXTExtName = VK_EXT_YCBCR_2PLANE_444_FORMATS_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto FragmentDensityMap2EXTExtName   = VK_EXT_FRAGMENT_DENSITY_MAP_2_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto RotatedCopyCommandsQCOMExtName  = VK_QCOM_ROTATED_COPY_COMMANDS_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_EXT_image_robustness extension has been promoted to core in version 1.3." )
  VULKAN_HPP_CONSTEXPR_INLINE auto ImageRobustnessEXTExtName               = VK_EXT_IMAGE_ROBUSTNESS_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto WorkgroupMemoryExplicitLayoutKHRExtName = VK_KHR_WORKGROUP_MEMORY_EXPLICIT_LAYOUT_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_KHR_copy_commands2 extension has been promoted to core in version 1.3." )
  VULKAN_HPP_CONSTEXPR_INLINE auto CopyCommands2KHRExtName                = VK_KHR_COPY_COMMANDS_2_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto ImageCompressionControlEXTExtName      = VK_EXT_IMAGE_COMPRESSION_CONTROL_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto AttachmentFeedbackLoopLayoutEXTExtName = VK_EXT_ATTACHMENT_FEEDBACK_LOOP_LAYOUT_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_EXT_4444_formats extension has been promoted to core in version 1.3." )
  VULKAN_HPP_CONSTEXPR_INLINE auto 4444FormatsEXTExtName = VK_EXT_4444_FORMATS_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto DeviceFaultEXTExtName = VK_EXT_DEVICE_FAULT_EXTENSION_NAME;
  ...
  VULKAN_HPP_CONSTEXPR_INLINE auto RasterizationOrderAttachmentAccessARMExtName = VK_ARM_RASTERIZATION_ORDER_ATTACHMENT_ACCESS_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto Rgba10X6FormatsEXTExtName                    = VK_EXT_RGBA10X6_FORMATS_EXTENSION_NAME;

#if defined( VK_USE_PLATFORM_WIN32_KHR )
  VULKAN_HPP_CONSTEXPR_INLINE auto AcquireWinrtDisplayNVExtName = VK_NV_ACQUIRE_WINRT_DISPLAY_EXTENSION_NAME;
#endif /*VK_USE_PLATFORM_WIN32_KHR*/

#if defined( VK_USE_PLATFORM_DIRECTFB_EXT )
  VULKAN_HPP_CONSTEXPR_INLINE auto DirectfbSurfaceEXTExtName = VK_EXT_DIRECTFB_SURFACE_EXTENSION_NAME;
#endif /*VK_USE_PLATFORM_DIRECTFB_EXT*/

  VULKAN_HPP_DEPRECATED( "The VK_VALVE_mutable_descriptor_type extension has been promoted to VK_EXT_mutable_descriptor_type." )
  VULKAN_HPP_CONSTEXPR_INLINE auto MutableDescriptorTypeVALVEExtName      = VK_VALVE_MUTABLE_DESCRIPTOR_TYPE_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto VertexInputDynamicStateEXTExtName      = VK_EXT_VERTEX_INPUT_DYNAMIC_STATE_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto PhysicalDeviceDrmEXTExtName            = VK_EXT_PHYSICAL_DEVICE_DRM_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto DeviceAddressBindingReportEXTExtName   = VK_EXT_DEVICE_ADDRESS_BINDING_REPORT_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto DepthClipControlEXTExtName             = VK_EXT_DEPTH_CLIP_CONTROL_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto PrimitiveTopologyListRestartEXTExtName = VK_EXT_PRIMITIVE_TOPOLOGY_LIST_RESTART_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_KHR_format_feature_flags2 extension has been promoted to core in version 1.3." )
  VULKAN_HPP_CONSTEXPR_INLINE auto FormatFeatureFlags2KHRExtName = VK_KHR_FORMAT_FEATURE_FLAGS_2_EXTENSION_NAME;

#if defined( VK_USE_PLATFORM_FUCHSIA )
  VULKAN_HPP_CONSTEXPR_INLINE auto ExternalMemoryFUCHSIAExtName    = VK_FUCHSIA_EXTERNAL_MEMORY_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto ExternalSemaphoreFUCHSIAExtName = VK_FUCHSIA_EXTERNAL_SEMAPHORE_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto BufferCollectionFUCHSIAExtName  = VK_FUCHSIA_BUFFER_COLLECTION_EXTENSION_NAME;
#endif /*VK_USE_PLATFORM_FUCHSIA*/

  VULKAN_HPP_CONSTEXPR_INLINE auto SubpassShadingHUAWEIExtName                 = VK_HUAWEI_SUBPASS_SHADING_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto InvocationMaskHUAWEIExtName                 = VK_HUAWEI_INVOCATION_MASK_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto ExternalMemoryRdmaNVExtName                 = VK_NV_EXTERNAL_MEMORY_RDMA_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto PipelinePropertiesEXTExtName                = VK_EXT_PIPELINE_PROPERTIES_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto FrameBoundaryEXTExtName                     = VK_EXT_FRAME_BOUNDARY_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto MultisampledRenderToSingleSampledEXTExtName = VK_EXT_MULTISAMPLED_RENDER_TO_SINGLE_SAMPLED_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_EXT_extended_dynamic_state2 extension has been promoted to core in version 1.3." )
  VULKAN_HPP_CONSTEXPR_INLINE auto ExtendedDynamicState2EXTExtName = VK_EXT_EXTENDED_DYNAMIC_STATE_2_EXTENSION_NAME;

#if defined( VK_USE_PLATFORM_SCREEN_QNX )
  VULKAN_HPP_CONSTEXPR_INLINE auto ScreenSurfaceQNXExtName = VK_QNX_SCREEN_SURFACE_EXTENSION_NAME;
#endif /*VK_USE_PLATFORM_SCREEN_QNX*/

  VULKAN_HPP_CONSTEXPR_INLINE auto ColorWriteEnableEXTExtName         = VK_EXT_COLOR_WRITE_ENABLE_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto PrimitivesGeneratedQueryEXTExtName = VK_EXT_PRIMITIVES_GENERATED_QUERY_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto RayTracingMaintenance1KHRExtName   = VK_KHR_RAY_TRACING_MAINTENANCE_1_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_EXT_global_priority_query extension has been promoted to VK_KHR_global_priority." )
  VULKAN_HPP_CONSTEXPR_INLINE auto GlobalPriorityQueryEXTExtName    = VK_EXT_GLOBAL_PRIORITY_QUERY_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto ImageViewMinLodEXTExtName        = VK_EXT_IMAGE_VIEW_MIN_LOD_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto MultiDrawEXTExtName              = VK_EXT_MULTI_DRAW_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto Image2DViewOf3DEXTExtName        = VK_EXT_IMAGE_2D_VIEW_OF_3D_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto PortabilityEnumerationKHRExtName = VK_KHR_PORTABILITY_ENUMERATION_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto ShaderTileImageEXTExtName        = VK_EXT_SHADER_TILE_IMAGE_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto OpacityMicromapEXTExtName        = VK_EXT_OPACITY_MICROMAP_EXTENSION_NAME;

#if defined( VK_ENABLE_BETA_EXTENSIONS )
  VULKAN_HPP_CONSTEXPR_INLINE auto DisplacementMicromapNVExtName = VK_NV_DISPLACEMENT_MICROMAP_EXTENSION_NAME;
#endif /*VK_ENABLE_BETA_EXTENSIONS*/

  VULKAN_HPP_CONSTEXPR_INLINE auto LoadStoreOpNoneEXTExtName           = VK_EXT_LOAD_STORE_OP_NONE_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto ClusterCullingShaderHUAWEIExtName   = VK_HUAWEI_CLUSTER_CULLING_SHADER_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto BorderColorSwizzleEXTExtName        = VK_EXT_BORDER_COLOR_SWIZZLE_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto PageableDeviceLocalMemoryEXTExtName = VK_EXT_PAGEABLE_DEVICE_LOCAL_MEMORY_EXTENSION_NAME;
  VULKAN_HPP_DEPRECATED( "The VK_KHR_maintenance4 extension has been promoted to core in version 1.3." )
  VULKAN_HPP_CONSTEXPR_INLINE auto Maintenance4KHRExtName                       = VK_KHR_MAINTENANCE_4_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto ShaderCorePropertiesARMExtName               = VK_ARM_SHADER_CORE_PROPERTIES_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto ImageSlicedViewOf3DEXTExtName                = VK_EXT_IMAGE_SLICED_VIEW_OF_3D_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto DescriptorSetHostMappingVALVEExtName         = VK_VALVE_DESCRIPTOR_SET_HOST_MAPPING_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto DepthClampZeroOneEXTExtName                  = VK_EXT_DEPTH_CLAMP_ZERO_ONE_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto NonSeamlessCubeMapEXTExtName                 = VK_EXT_NON_SEAMLESS_CUBE_MAP_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto FragmentDensityMapOffsetQCOMExtName          = VK_QCOM_FRAGMENT_DENSITY_MAP_OFFSET_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto CopyMemoryIndirectNVExtName                  = VK_NV_COPY_MEMORY_INDIRECT_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto MemoryDecompressionNVExtName                 = VK_NV_MEMORY_DECOMPRESSION_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto DeviceGeneratedCommandsComputeNVExtName      = VK_NV_DEVICE_GENERATED_COMMANDS_COMPUTE_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto LinearColorAttachmentNVExtName               = VK_NV_LINEAR_COLOR_ATTACHMENT_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto SurfacelessQueryGOOGLEExtName                = VK_GOOGLE_SURFACELESS_QUERY_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto ImageCompressionControlSwapchainEXTExtName   = VK_EXT_IMAGE_COMPRESSION_CONTROL_SWAPCHAIN_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto ImageProcessingQCOMExtName                   = VK_QCOM_IMAGE_PROCESSING_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto NestedCommandBufferEXTExtName                = VK_EXT_NESTED_COMMAND_BUFFER_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto ExternalMemoryAcquireUnmodifiedEXTExtName    = VK_EXT_EXTERNAL_MEMORY_ACQUIRE_UNMODIFIED_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto ExtendedDynamicState3EXTExtName              = VK_EXT_EXTENDED_DYNAMIC_STATE_3_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto SubpassMergeFeedbackEXTExtName               = VK_EXT_SUBPASS_MERGE_FEEDBACK_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto DirectDriverLoadingLUNARGExtName             = VK_LUNARG_DIRECT_DRIVER_LOADING_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto ShaderModuleIdentifierEXTExtName             = VK_EXT_SHADER_MODULE_IDENTIFIER_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto RasterizationOrderAttachmentAccessEXTExtName = VK_EXT_RASTERIZATION_ORDER_ATTACHMENT_ACCESS_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto OpticalFlowNVExtName                         = VK_NV_OPTICAL_FLOW_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto LegacyDitheringEXTExtName                    = VK_EXT_LEGACY_DITHERING_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto PipelineProtectedAccessEXTExtName            = VK_EXT_PIPELINE_PROTECTED_ACCESS_EXTENSION_NAME;

#if defined( VK_USE_PLATFORM_ANDROID_KHR )
  VULKAN_HPP_CONSTEXPR_INLINE auto ExternalFormatResolveANDROIDExtName = VK_ANDROID_EXTERNAL_FORMAT_RESOLVE_EXTENSION_NAME;
#endif /*VK_USE_PLATFORM_ANDROID_KHR*/

  VULKAN_HPP_CONSTEXPR_INLINE auto Maintenance5KHRExtName                       = VK_KHR_MAINTENANCE_5_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto RayTracingPositionFetchKHRExtName            = VK_KHR_RAY_TRACING_POSITION_FETCH_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto ShaderObjectEXTExtName                       = VK_EXT_SHADER_OBJECT_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto TilePropertiesQCOMExtName                    = VK_QCOM_TILE_PROPERTIES_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto AmigoProfilingSECExtName                     = VK_SEC_AMIGO_PROFILING_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto MultiviewPerViewViewportsQCOMExtName         = VK_QCOM_MULTIVIEW_PER_VIEW_VIEWPORTS_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto RayTracingInvocationReorderNVExtName         = VK_NV_RAY_TRACING_INVOCATION_REORDER_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto ExtendedSparseAddressSpaceNVExtName          = VK_NV_EXTENDED_SPARSE_ADDRESS_SPACE_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto MutableDescriptorTypeEXTExtName              = VK_EXT_MUTABLE_DESCRIPTOR_TYPE_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto ShaderCoreBuiltinsARMExtName                 = VK_ARM_SHADER_CORE_BUILTINS_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto PipelineLibraryGroupHandlesEXTExtName        = VK_EXT_PIPELINE_LIBRARY_GROUP_HANDLES_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto DynamicRenderingUnusedAttachmentsEXTExtName  = VK_EXT_DYNAMIC_RENDERING_UNUSED_ATTACHMENTS_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto LowLatency2NVExtName                         = VK_NV_LOW_LATENCY_2_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto CooperativeMatrixKHRExtName                  = VK_KHR_COOPERATIVE_MATRIX_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto MultiviewPerViewRenderAreasQCOMExtName       = VK_QCOM_MULTIVIEW_PER_VIEW_RENDER_AREAS_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto ImageProcessing2QCOMExtName                  = VK_QCOM_IMAGE_PROCESSING_2_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto FilterCubicWeightsQCOMExtName                = VK_QCOM_FILTER_CUBIC_WEIGHTS_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto YcbcrDegammaQCOMExtName                      = VK_QCOM_YCBCR_DEGAMMA_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto FilterCubicClampQCOMExtName                  = VK_QCOM_FILTER_CUBIC_CLAMP_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto AttachmentFeedbackLoopDynamicStateEXTExtName = VK_EXT_ATTACHMENT_FEEDBACK_LOOP_DYNAMIC_STATE_EXTENSION_NAME;

#if defined( VK_USE_PLATFORM_SCREEN_QNX )
  VULKAN_HPP_CONSTEXPR_INLINE auto ExternalMemoryScreenBufferQNXExtName = VK_QNX_EXTERNAL_MEMORY_SCREEN_BUFFER_EXTENSION_NAME;
#endif /*VK_USE_PLATFORM_SCREEN_QNX*/

  VULKAN_HPP_CONSTEXPR_INLINE auto LayeredDriverMSFTExtName              = VK_MSFT_LAYERED_DRIVER_EXTENSION_NAME;
  VULKAN_HPP_CONSTEXPR_INLINE auto DescriptorPoolOverallocationNVExtName = VK_NV_DESCRIPTOR_POOL_OVERALLOCATION_EXTENSION_NAME;
